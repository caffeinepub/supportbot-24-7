...
export class Backend implements backendInterface {
    ...
    async addFaq(arg0: FaqInput): Promise<FaqId> {
        if (this.processError) {
            try {
    ...
    async deleteFaq(arg0: FaqId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getFaqByCategory(arg0: string): Promise<Array<Faq>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFaqByCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTicketStatus(arg0: TicketId): Promise<string | null> {
        if (this.processError) {
            try {
    ...
    async submitTicket(arg0: TicketInput): Promise<TicketId> {
        if (this.processError) {
            try {
                const result = await this.actor.submitTicket(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateFaq(arg0: FaqId, arg1: FaqInput): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateTicket(arg0: TicketId, arg1: TicketUpdateInput): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateTicket(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
